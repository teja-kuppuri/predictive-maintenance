...
HF_DATASET_REPO = "treddy333/vehicle-breakdown-predictive-maintenance"
HF_MODEL_REPO = "treddy333/vehicle-breakdown-preventive-maintenance-model"

tracking_uri = os.getenv("MLFLOW_TRACKING_URI", "http://127.0.0.1:5000")
mlflow.set_tracking_uri(tracking_uri)
mlflow.set_experiment("preventive-maintenance-mlops-training-experiment")
...
# All model inputs are numeric engine sensor values
...
with mlflow.start_run():
    grid_search = GridSearchCV(
        model_pipeline, param_grid, cv=5, scoring="f1", n_jobs=-1, refit=True, return_train_score=True
    )
    ...
    model_path = "best_preventive_prod_model_v1.joblib"
